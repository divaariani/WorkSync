...
class AppLocalizations {
  ...
  final Map<String, Map<String, String>> _localizedValues = {
    ...
    'ko': {
      ...
      'sureChangeLocation' : "위치를 변경하시겠습니까?",
      ...
      'result': "결과",
      'ticketing' : "보고서",
      'machineScan' : "기계 코드 스캔",
      'machine' : "기계",
      'machineOut' : "기계를 끄시겠습니까",
      'machineAttendanceFailed' : "기계 출석에 실패했습니다",
      'machineStatus' : "기계 상태",
      'machineCodeRequire' : "기계코드를 스캔하지 않았습니다",
      'machineMonitoring' : "기계 모니터링",
      'action' : "행동",
      'operator' : "기계 조작원",
      'operatorAttendance' : "기계 조작원 출석",
      'startAnyway' : "그냥 시작",
    },
  };
