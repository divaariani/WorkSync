...
class _ApprovalsPageState extends State<ApprovalsPage> {
                      ...
                      child: FutureBuilder<List<OvertimeData>>(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            return Text(AppLocalizations(globalLanguage)
                                .translate("noDataa"));
                            ...
                            List<OvertimeData> overtimeList =
                                snapshot.data ?? [];
                            ...
                            if (searchController.text.isNotEmpty) {
                              ...
                              overtimeList = overtimeList.where((data) {
                                return data.employeeName
                                        .toLowerCase()
                                        .contains(query) ||
                                    formatLanguageFullDate(data.ovtDateStart)
                                        .toLowerCase()
                                        .contains(query) ||
                                    formatLanguageFullDate(data.ovtDateEnd)
                                        .toLowerCase()
                                        .contains(query) ||
                                                          ...
                                                          actions: [
                                                            ...
                                                            TextButton(
                                                              onPressed:
                                                                  () async {
                                                                try {
                                                                  await approvalsController
                                                                      .postRejectOvertime(data
                                                                          .ovtId
                                                                          .toString());
                                                                  ...
                                                                  setState(() {
                                                                    OvertimeController()
                                                                            .futureData =
                                                                        OvertimeController()
                                                                            .fetchData(SessionManager().getNoAbsen());
                                                                  });
  ...
  String formatLanguageFullDate(String dateString) {
    ...
    final String formattedDate =
        DateFormat('dd MMM yyyy [HH:mm]', globalLanguage.toLanguageTag())
            .format(dateTime);
