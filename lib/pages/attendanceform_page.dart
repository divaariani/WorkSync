                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Center(
                          child: Visibility(
                            visible:
                                globalLat.isNotEmpty && globalLong.isNotEmpty,
                            child: GestureDetector(
                              onTap: () async {
                                String tap = selectedType ==
                                        AppLocalizations(globalLanguage)
                                            .translate("checkOut")
                                    ? 'P'
                                    : 'M';
                                ...
                                try {
                                  ...
                                  final snackBar = SnackBar(
                                    ...
                                    content: AwesomeSnackbarContent(
                                      title: AppLocalizations(globalLanguage)
                                          .translate("attendancePosted"),
                                      message: AppLocalizations(globalLanguage)
                                          .translate("attendancePostedDesc"),
                                  ...
                                  final snackBar = SnackBar(
                                    ...
                                    content: AwesomeSnackbarContent(
                                      title: AppLocalizations(globalLanguage)
                                          .translate("attendanceFailed"),
                                      message: AppLocalizations(globalLanguage)
                                          .translate("attendanceFailedDesc"),
