                        ...
                        if (snapshot.connectionState ==
                          ...
                          if (searchController.text.isNotEmpty) {
                            ...
                            overtimeList = overtimeList.where((overtime) {
                              return overtime['Ovt_Noted']
                                      .toLowerCase()
                                      .contains(query) ||
                                  formatLanguageFullDate(
                                          overtime['Ovt_Date_Start'])
                                      .toLowerCase()
                                      .contains(query) ||
                                  formatLanguageFullDate(
                                          overtime['Ovt_Date_End'])
                                      .toLowerCase()
                                      .contains(query);
                            }).toList();
                          }
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Column(
                                  children: [
                                    ...
                                    if (index == overtimeList.length - 1)
