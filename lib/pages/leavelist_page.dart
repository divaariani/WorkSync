...
import 'leaveformedit_page.dart';
...
class _LeaveListPageState extends State<LeaveListPage> {
  ...
  Future<void> init() async {
    LeaveUrlController service = LeaveUrlController();
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                FutureBuilder<LeaveController>(
                  future: LeaveUrlController().fetchData(),
                      ...
                      if (searchController.text.isNotEmpty) {
                        ...
                        leaveList = leaveList.where((leave) {
                          return leave.status.toLowerCase().contains(query) ||
                              (query == 'requested' && leave.status.toLowerCase() == 'open/draft') ||
                              (query == 'approved' && leave.status.toLowerCase() == 'manager signed') ||
                              leave.keterangan.toLowerCase().contains(query) ||
                              formatLanguageFullDate(leave.dari).toLowerCase().contains(query) ||
                              formatLanguageFullDate(leave.sampai).toLowerCase().contains(query);
                        }).toList();
                      }
