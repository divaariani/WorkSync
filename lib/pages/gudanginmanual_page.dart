...
class GudangInManualPage extends StatefulWidget {
  final String? auditorData;

  const GudangInManualPage({Key? key, this.auditorData}) : super(key: key);

  @override
  State<GudangInManualPage> createState() => _GudangInManualPageState();
}

class _GudangInManualPageState extends State<GudangInManualPage> {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: AppBar(
            centerTitle: true,
            title: Text(
              AppLocalizations(globalLanguage).translate("warehouseform"),
              style: TextStyle(
