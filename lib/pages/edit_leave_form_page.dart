...
import 'package:worksync/pages/leave_list_page.dart';
import 'package:worksync/service/leave_list_model.dart';
import 'package:worksync/service/leave_type_model.dart';
import 'package:worksync/service/submit_edit_service.dart';
import 'package:worksync/service/submit_leave_service.dart';
import '../service/leave_type_service.dart';
...
class _EditLeaveFormPageState extends State<EditLeaveFormPage> {
  ...
  String noAbsen = '';
  String attLeaveId = '';
  DatumLeaveType? previousSelectedLeaveType;
  ...
  DatumLeaveType? selectedLeaveType;
  ...
  Future<void> _updateLeaveTypes() async {
    ...
    LeaveTypeModel leaveTypeModel = await apiProvider.fetchLeaveTypes();
  ...
  Future<List<DatumLeaveType>> _getList() async {
    ApiProvider apiProvider = ApiProvider();
  ...
  Future<void> _initAsync() async {
    ...
    setState(() {
      ...
      selectedLeaveType = DatumLeaveType(
  ...
  Future<void> _submitData() async {
    ...
    if (widget.data != null && attachment.isNotEmpty) {
      try {
        ...
        await ApiEditSubmitLeave().submitEditData(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const SizedBox(height: 5),
                  DropdownSearch<DatumLeaveType>(
                    asyncItems: (String filter) => _getList(),
                    itemAsString: (DatumLeaveType u) => u.statusAbsensi,
                    onChanged: (DatumLeaveType? data) {
                      if (data != null) {
